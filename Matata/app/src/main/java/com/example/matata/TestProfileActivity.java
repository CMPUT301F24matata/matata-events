...
/**
 * The `TestProfileActivity` class is a test implementation of the profile management feature in the Matata app.
 * It allows users to view, edit, and save their profile information, including name, email, phone number, gender, and date of birth.
 * Users can also upload and manage their profile pictures. Notifications can be enabled or disabled.
 *
 * <h2>Key Features:</h2>
 * <ul>
 *     <li>Profile information editing and saving functionality.</li>
 *     <li>Profile picture management with support for custom images or autogenerated initials-based images.</li>
 *     <li>Integration with Firebase Firestore for storing and retrieving profile data.</li>
 *     <li>Custom gender and date of birth inputs using a spinner and a date picker dialog.</li>
 *     <li>Notification toggle to manage opt-in and opt-out preferences.</li>
 * </ul>
 *
 * <h2>Outstanding Issues:</h2>
 * <ul>
 *     <li>Profile image handling relies on SharedPreferences, which may not persist across devices.</li>
 *     <li>Facility-related functionality is only initialized when the user toggles the organizer switch.</li>
 * </ul>
 */
